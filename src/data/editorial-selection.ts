...
export const editorialSelection: EditorialSelection[] = [
  ...
  { filename: 'P1260248.jpg', derivative: 'water-portrait.jpg', role: 'anchor', world: 'people', destination: null, monochrome: true, peoplePresent: true, emotionalIntensity: 5, heroPotential: 4, visualRhythmUse: 'intimacy', surfaces: ['home', 'black-and-white'] },
  ...
  { filename: '1200794-2.jpg', derivative: 'bw-reflection.jpg', role: 'anchor', world: 'black-and-white', destination: null, monochrome: true, peoplePresent: true, emotionalIntensity: 4, heroPotential: 4, visualRhythmUse: 'transition', surfaces: ['home', 'black-and-white'] },
  { filename: 'IMG_8992.jpg', derivative: 'bw-artisan.jpg', role: 'editorial', world: 'black-and-white', destination: null, monochrome: true, peoplePresent: true, emotionalIntensity: 4, heroPotential: 3, visualRhythmUse: 'intimacy', surfaces: ['home', 'black-and-white'] },
  ...
  { filename: '1210415-2.jpg', derivative: 'bw-stall.jpg', role: 'support', world: 'black-and-white', destination: null, monochrome: true, peoplePresent: false, emotionalIntensity: 3, heroPotential: 2, visualRhythmUse: 'pause', surfaces: ['black-and-white'] },
  { filename: 'P1280613.jpg', derivative: 'bw-sculpture.jpg', role: 'editorial', world: 'black-and-white', destination: null, monochrome: true, peoplePresent: false, emotionalIntensity: 3, heroPotential: 3, visualRhythmUse: 'transition', surfaces: ['black-and-white'] },
